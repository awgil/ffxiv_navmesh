...
public class MainWindow : Window, IDisposable
{
    ...
    public MainWindow(NavmeshManager manager, FollowPath path, AsyncMoveRequest move) : base("Navmesh")
    {
        _debugGameColl = new(_dd);
        _debugNavmeshManager = new(_dd, _debugGameColl, manager, path, move);
